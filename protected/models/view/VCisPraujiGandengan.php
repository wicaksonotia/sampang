...
/**
 * This is the model class for table "v_cis_prauji_gandengan".
 *
 * The followings are the available columns in table 'v_cis_prauji_gandengan':
 ...
 */
class VCisPraujiGandengan extends CActiveRecord
{
	/**
	 ...
	 * @return VCisPraujiGandengan the static model class
	 */
