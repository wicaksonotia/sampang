...
/**
 * This is the model class for table "v_uji_mekanis".
 *
 * The followings are the available columns in table 'v_uji_mekanis':
 ...
 */
class VUjiMekanis extends CActiveRecord {

    /**
     * @return string the associated database table name
     */
    public function tableName() {
        return 'v_uji_mekanis';
    }
    ...
    public function rules() {
        ...
        return array(
            array('id_uji, alat', 'numerical', 'integerOnly' => true),
     ...
     * @return VUjiMekanis the static model class
     */
