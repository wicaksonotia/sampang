...
/**
 * This is the model class for table "v_cis_lampu".
 *
 * The followings are the available columns in table 'v_cis_lampu':
 ...
 */
class VCisLampu extends CActiveRecord
{
	/**
	 ...
	 * @return VCisLampu the static model class
	 */
