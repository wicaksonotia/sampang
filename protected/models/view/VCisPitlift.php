...
/**
 * This is the model class for table "v_cis_pitlift".
 *
 * The followings are the available columns in table 'v_cis_pitlift':
 ...
 */
class VCisPitlift extends CActiveRecord
{
	/**
	 ...
	 * @return VCisPitlift the static model class
	 */
