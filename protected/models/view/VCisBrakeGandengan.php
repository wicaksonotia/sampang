...
/**
 * This is the model class for table "v_cis_brake_gandengan".
 *
 * The followings are the available columns in table 'v_cis_brake_gandengan':
 ...
 */
class VCisBrakeGandengan extends CActiveRecord
{
	/**
	 ...
	 * @return VCisBrakeGandengan the static model class
	 */
