...
/**
 * This is the model class for table "v_cis_prauji".
 *
 * The followings are the available columns in table 'v_cis_prauji':
 ...
 */
class VCisPrauji extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('no_antrian, stts_no, id_kendaraan, id_hasil_uji, id_daftar, prauji, cetak, no_kendaraan, nama_pemilik, id_jns_kend, merk, tahun, tipe, img1, img2', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('no_antrian, stts_no, id_kendaraan, id_hasil_uji, id_daftar, prauji, cetak, no_kendaraan, no_uji, nama_pemilik, keterangan, id_jns_kend, merk, tahun, tipe, antri, karoseri_jenis, bahan_bakar, nm_komersil, karoseri_bahan, konsumbu, img1, img2', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return VCisPrauji the static model class
	 */
