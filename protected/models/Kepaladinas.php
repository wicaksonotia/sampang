...
/**
 * This is the model class for table "kepaladinas".
 *
 * The followings are the available columns in table 'kepaladinas':
 * @property string $idx
 ...
 */
class Kepaladinas extends CActiveRecord
{
	/**
	 ...
	 * @return Kepaladinas the static model class
	 */
