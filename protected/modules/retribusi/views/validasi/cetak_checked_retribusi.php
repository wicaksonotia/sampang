...
foreach ($idArray as $id_retribusi):
    ...
    <div id="pages">
        ...
        <table width="99%" style="font-size: 7pt;">
            ...
            <tr>
                <td colspan="2">
                    <table id="table_retribusi" style="font-size: 10pt;" width="100%">
                        <tr>
                        ...
                        <tr>
                            ...
                            if (empty($data_retribusi->b_denda_kecil)) {
                                ...
                                $jmlKecil = $data_retribusi->lm_tlt;
                        ...
                        <tr>
                            ...
                            if (empty($data_retribusi->b_denda_besar)) {
                                ...
                                $jmlBesar = $data_retribusi->lm_tlt;
                        ...
                        <tr>
                            ...
                            <td valign="middle" width="10px">Rp.</td>
                            <td valign="middle" align="right"><span style="font-size: 10pt; font-weight: bold;"><?php echo number_format($data_retribusi->total, 0, ',', '.'); ?></span></td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <div style="margin-bottom: 5px;">TERBILANG : <span style="font-weight: bold;"><?php echo ucwords(strtolower(Yii::app()->appComponent->konversiUang($data_retribusi->total))) . " Rupiah"; ?></span></div>
                </td>
            </tr>
        </table>
    </div>
