...
<div class="box box-info">
    <div class="box-header with-border">
        <h3 class="box-title">Munculin Kembali</h3>
    </div><!-- /.box-header -->
    <div class="box-body">
        <?php
...
//                'class' => 'form-horizontal',
        ...
        ?>
        <font style="color:red">*HANYA UNTUK LOKET 1 DIDALAM RUANGAN :)</font>
        <table class="table">
            <thead>
                <tr>
        ...
        <span class="pull-right">
            <?php
            $urlActForm = $this->createUrl('Default/ProsesMunculinKembali');
