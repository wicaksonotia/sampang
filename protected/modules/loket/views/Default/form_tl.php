...
<div class="box box-info">
    <div class="box-header with-border">
        <h3 class="box-title">X-TL dan TD Manual</h3>
    </div><!-- /.box-header -->
    <div class="box-body">
        <?php
...
//                'class' => 'form-horizontal',
        ...
        <span class="pull-left">
            <?php
            $urlActForm = $this->createUrl('Default/ProsesDaftarTlManual');
            echo CHtml::Button('Proses', array('onclick' => "submitForm('$urlActForm')", 'class' => 'btn btn-primary'));
            ?>
        </span>
        <?php
        $this->endWidget();
