...
class PrinthasilController extends Controller
{
    ...
    public function actionSaveCetakLulus()
    {
         ...
         */
        $jbki = '0';
        $tglUji = date('m/d/Y', strtotime($dtHasilUji->jdatang));
        ...
        // $tglsertifikatreg =
        //     date('dmY', strtotime($dtHasilUji->tgl_regis));
        ...
        $jumlahsumbu = 2;
        $alatuji_gayapengereman1kanan = round($dtHasilUji->grem_sb1 * 51 / 100);
        $alatuji_gayapengereman2kanan = 0;
        $alatuji_gayapengereman3kanan = 0;
        $alatuji_gayapengereman4kanan = 0;
        $alatuji_gayapengereman1kiri = round($dtHasilUji->grem_sb1 * 49 / 100);
        $alatuji_gayapengereman2kiri = 0;
        $alatuji_gayapengereman3kiri = 0;
        $alatuji_gayapengereman4kiri = 0;
        if ($bsumbu5 != 0) {
            $jumlahsumbu = 5;
        } else if ($bsumbu4 != 0) {
            $jumlahsumbu = 4;
            $alatuji_gayapengereman4kanan = round($dtHasilUji->grem_sb3 * 51 / 100);
            $alatuji_gayapengereman4kiri = round($dtHasilUji->grem_sb3 * 49 / 100);
        } else if ($bsumbu3 != 0) {
            $jumlahsumbu = 3;
            $alatuji_gayapengereman3kanan = round($dtHasilUji->grem_sb2 * 51 / 100);
            $alatuji_gayapengereman3kiri = round($dtHasilUji->grem_sb2 * 49 / 100);
        } else if ($bsumbu2 != 0) {
            $jumlahsumbu = 2;
            $alatuji_gayapengereman2kanan = round($dtHasilUji->grem_sb1 * 51 / 100);
            $alatuji_gayapengereman2kiri = round($dtHasilUji->grem_sb1 * 49 / 100);
        }
        ...
        $alatuji_remutamatotalgayapengereman = round($dtHasilUji->beratgaya);
        ...
        $alatuji_remparkirtotalgayapengereman = round(($alatuji_remparkirkaki + $alatuji_remparkirtangan) / 2);
        $alatuji_gayapengeremanparkirkanan = round($alatuji_remparkirtotalgayapengereman * 49 / 100);
        $alatuji_gayapengeremanparkirkiri =
            round($alatuji_remparkirtotalgayapengereman * 51 / 100);
