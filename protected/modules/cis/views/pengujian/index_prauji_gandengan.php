    ...
    <div class="col-lg-12">
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="col-lg-12 col-md-12 no-padding">
                    <div class="col-lg-8 col-md-8 no-padding">
                        <div class="col-lg-3 col-md-3 no-padding">
                            <input type="text" id="text_search_prauji" class="text-besar form-control" placeholder="NO KEND / NO UJI">
                        </div>
                ...
                <div class="col-lg-12 col-md-12 no-padding" style="margin-top: 20px">
                    <input type="hidden" value="gandengan" readonly="readonly" id="text_category_prauji" />
<!--                    <center>
                        <button type="button" class="btn btn-info" onclick="prosesSearchPrauji()">
                            <span class="glyphicon glyphicon-refresh"></span> REFRESH
                        </button>
                ...
                <div class="row" style="margin-bottom: 20px">
                    <div class="col-lg-8 col-md-8">
                        <div class="col-lg-3 col-md-3">
                            <input type="text" id="no_antrian_prauji" class="form-control" placeholder="NO ANTRIAN" readonly="readonly" style="font-weight: bold;"/>
                        </div>
                        <div class="col-lg-3 col-md-3">
                ...
                <div class="row" style="margin-bottom:20px;">
                    <center>
                        <table cellspacing="10">
                            <tr>
                                <td colspan="2" align="center"><strong>6 BULAN LALU</strong></td>
                                <td>&nbsp;</td>
                                <td colspan="2" align="center"><strong>SEKARANG</strong></td>
                            </tr>
                            <tr>
                                <td><img id="img1" width="190" height="160"/></td>
                                <td><img id="img2" width="190" height="160"/></td>
                                <td>&nbsp;</td>
                                <td><img id="img3" width="190" height="160"/></td>
                                <td><img id="img4" width="190" height="160"/></td>
                            </tr>
                        </table>
                    </center>
                </div>
                            ...
                            <div class="tab-pane" id="tab_3">
                                <table width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <select size="1" class="ui-state-default" id="jnsbody">
                                                <option value="">Pilih Item</option>                       
                                                <?php
...
<!--                    <div class="box box-danger">
                        ...
                        <div class="box-body">
                            <div class="col-lg-12 col-md-12 no-padding" style="margin-top: 20px">
                                <table id="praujiLainListGrid"></table>
                            </div>
                        </div>
                    </div>-->
                </div>
...
<script>
    $('#praujiListGrid').datagrid({
        url: '<?php echo $this->createUrl('PraujiGandengan/ListGrid'); ?>',
        pagination: true,
        singleSelect: true,
        selectOnCheck: true,
        checkOnSelect: true,
