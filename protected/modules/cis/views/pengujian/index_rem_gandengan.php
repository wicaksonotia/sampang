                ...
                <div class="row" style="margin-bottom: 20px">
                    <div class="col-lg-8 col-md-8">
                        <div class="col-lg-3 col-md-3">
                            <input type="text" id="no_antrian_rem" class="form-control" placeholder="NO ANTRIAN" readonly="readonly" style="font-weight: bold;"/>
                        </div>
                        <div class="col-lg-3 col-md-3">
                            <input type="hidden" value="gandengan" readonly="readonly" id="text_category_rem" />
                            ...
                            <input type="hidden" id="posisi_cis_rem" readonly="readonly" value=""/>
                        ...
                        <div class="col-lg-1 col-md-2">
                            <button type="button" class="btn btn-info" onclick="reloadDataRem('<?php echo $this->createUrl('Rem/ReloadData'); ?>')">RELOAD</button>
                        </div>
                        <div class="col-lg-1 col-md-2">
...
<script>
    $('#remListGrid').datagrid({
        url: '<?php echo $this->createUrl('RemGandengan/ListGrid'); ?>',
        pagination: true,
        singleSelect: true,
        selectOnCheck: true,
        checkOnSelect: true,
