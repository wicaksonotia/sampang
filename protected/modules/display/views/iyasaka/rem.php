...
<!--    <div class="col-lg-12" style="width: 100%">
        <img src="<?php // echo Yii::app()->baseUrl; ?>/images/logo_dishub.png" class="pull-left" />
        <div style="padding:0px; margin:0px"><span class="box-title bold" style="font-size: 36pt">UPTD PKB Wiyung</span></div>
        <div style="padding:0px; margin:0px"><span class="box-title bold" style="font-size: 36pt">DISHUB KOTA SURABAYA</span></div>
    </div>-->
    <div class="col-lg-12" style="width: 100%">
