<script type="text/javascript">
    $(document).ready(function ($) {
        $('#containerKendaraanTl').highcharts({
            chart: {
                type: 'column'
            },
            title: {
            ...
            ?>
            {
                ...
                for ($bln = 1; $bln <= 12; $bln++):
                    $dataSum = TblDaftar::model()->totalKelulusanKendaraanPerBulan('false', $bln, $tahun, '', '');
                    echo $dataSum . ', ';
                endfor;
                ?>
                ]
...
<div id="containerKendaraanTl" style="min-width: 310px; height: 310px; margin: 0 auto"></div>