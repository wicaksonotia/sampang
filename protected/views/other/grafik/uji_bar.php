<script type="text/javascript">
    $(document).ready(function ($) {
        $('<?php echo "#" . $idContainer; ?>').highcharts({
            chart: {
                type: 'column'
            },
            title: {
            ...
            ?>
                {
                    ...
                    for ($bln = 1; $bln <= 12; $bln++):
                        $dataSum = TblRetribusi::model()->totalUji($bln, $tahun, $idUji);
                        echo $dataSum . ', ';
                    endfor;
                    ?>
                    ]
...
<div id="<?php echo $idContainer; ?>" style="min-width: 310px; height: 310px; margin: 0 auto"></div>